...
namespace bae
{
	...
	public:
		...
		constexpr Color(in<std::uintx_t<8 * 4>> hex) noexcept;

		constexpr Color& operator=(in<std::uintx_t<8 * 4>> hex) noexcept;
	...
	public:
		...
		constexpr ColorF(in<std::uintx_t<8 * 4>> hex) noexcept;

		constexpr ColorF& operator=(in<std::uintx_t<8 * 4>> hex) noexcept;
